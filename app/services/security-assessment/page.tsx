  ...
  const benefits = [
    {
      ...
      description: 'Discover security weaknesses before attackers do',
    ...
    },
    {
      ...
      description: 'Professional security analysis and recommendations',
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl text-primary-700 mb-8 leading-relaxed">
              Comprehensive security assessments and penetration testing to identify 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-body text-gray-600 mb-6">
                Our security assessment and penetration testing services help organizations 
                identify vulnerabilities, assess risks, and implement effective security controls.
              </p>
              <p className="text-body text-gray-600 mb-6">
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Comprehensive scanning and analysis of security weaknesses</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <i className="fa-solid fa-check-circle text-green-500 mt-1 mr-3 text-xl"></i>
                  <div>
                    ...
                    <p className="text-gray-600">Real-world attack simulation and testing</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <i className="fa-solid fa-check-circle text-green-500 mt-1 mr-3 text-xl"></i>
                  <div>
                    ...
                    <p className="text-gray-600">Comprehensive findings and remediation guidance</p>
                  </div>
                </li>
              </ul>
            </div>
        ...
        <div className="container-custom">
          <div className="text-center mb-12">
            ...
            <p className="text-body text-gray-600 max-w-3xl mx-auto">
              Our security assessment solutions cover all aspects of vulnerability 
        ...
        <div className="container-custom text-center">
          <div className="relative overflow-hidden bg-gradient-to-r from-primary-500 to-primary-600 rounded-3xl p-12 shadow-2xl">
            ...
            <div className="relative z-10">
              <h2 className="text-3xl font-bold text-white mb-4">Ready to Assess Your Security?</h2>
              <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
                Let's discuss how our security assessment services can help you identify 
                vulnerabilities and strengthen your security posture.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
