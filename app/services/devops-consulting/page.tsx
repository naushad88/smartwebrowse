...
export default function DevOpsConsultingPage() {
  const features = [
    'DevOps maturity assessment and strategy',
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl text-primary-700 mb-8 leading-relaxed">
              Expert DevOps consulting services to help you transform your development 
              and operations processes, improve efficiency, and accelerate software delivery.
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-body text-gray-600 mb-6">
                Our DevOps consulting services help organizations assess their current 
                processes, identify improvement opportunities, and implement best practices.
              </p>
              <p className="text-body text-gray-600 mb-6">
                We provide strategic guidance, process optimization, and implementation 
                support to help you achieve DevOps excellence and business agility.
              </p>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8">
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900">DevOps Strategy</h4>
                    <p className="text-gray-600">Comprehensive transformation roadmap and plan</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <i className="fa-solid fa-check-circle text-green-500 mt-1 mr-3 text-xl"></i>
                  <div>
                    ...
                    <p className="text-gray-600">Streamlined workflows and best practices</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <i className="fa-solid fa-check-circle text-green-500 mt-1 mr-3 text-xl"></i>
                  <div>
                    ...
                    <p className="text-gray-600">Expert guidance throughout the transformation</p>
                  </div>
                </li>
              </ul>
            </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container-custom">
          <div className="text-center mb-12">
            <h2 className="heading-2 mb-6 text-gray-900">
              Comprehensive DevOps Consulting Features
            </h2>
            <p className="text-body text-gray-600 max-w-3xl mx-auto">
              Our DevOps consulting solutions cover all aspects of transformation, 
              ensuring comprehensive process optimization and implementation success.
            </p>
          </div>
          ...
          <div className="relative overflow-hidden bg-gradient-to-r from-primary-500 to-primary-600 rounded-3xl p-12 shadow-2xl">
            ...
            <div className="relative z-10">
              ...
              <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
                Let's discuss how our DevOps consulting services can help you optimize 
                your processes and accelerate software delivery.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
