...
export default function MonitoringLoggingPage() {
  ...
  const benefits = [
    ...
    },
    {
      ...
      description: 'Identify issues before they impact users',
    ...
    },
    {
      ...
      description: 'Reduce downtime and improve reliability',
    ...
    <div>
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl text-primary-700 mb-8 leading-relaxed">
              Comprehensive monitoring and logging services to ensure your applications 
              and infrastructure are performing optimally with real-time visibility and alerting.
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-body text-gray-600 mb-6">
                Our monitoring and logging services help organizations gain real-time 
                visibility into their applications and infrastructure performance.
              </p>
              <p className="text-body text-gray-600 mb-6">
                We implement comprehensive monitoring solutions that provide proactive 
                alerting, performance insights, and operational intelligence.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                <Link href="/consultation" className="btn-primary">
                  Get Free DevOps Assessment
                </Link>
                <Link href="/services/infrastructure-as-code" className="btn-outline">
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Comprehensive monitoring and alerting system</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <i className="fa-solid fa-check-circle text-green-500 mt-1 mr-3 text-xl"></i>
                  <div>
                    <h4 className="font-semibold text-gray-900">Log Management</h4>
                    <p className="text-gray-600">Centralized logging and log analysis</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <i className="fa-solid fa-check-circle text-green-500 mt-1 mr-3 text-xl"></i>
                  <div>
                    ...
                    <p className="text-gray-600">Tailored monitoring dashboards and reports</p>
                  </div>
                </li>
              </ul>
            </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container-custom">
          <div className="text-center mb-12">
            <h2 className="heading-2 mb-6 text-gray-900">
              Comprehensive Monitoring & Logging Features
            </h2>
            <p className="text-body text-gray-600 max-w-3xl mx-auto">
              Our monitoring and logging solutions cover all aspects of observability, 
              ensuring comprehensive visibility and operational intelligence.
            </p>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="container-custom">
          <div className="text-center mb-12">
            <h2 className="heading-2 mb-6 text-gray-900">
              Why Choose Our Monitoring & Logging Services?
            </h2>
            <p className="text-body text-gray-600 max-w-3xl mx-auto">
              We deliver measurable results that enhance your operational visibility and 
        ...
        <div className="container-custom text-center">
          <div className="relative overflow-hidden bg-gradient-to-r from-primary-500 to-primary-600 rounded-3xl p-12 shadow-2xl">
            ...
            <div className="relative z-10">
              <h2 className="text-3xl font-bold text-white mb-4">Ready to Gain Complete Visibility?</h2>
              <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
                Let's discuss how our monitoring and logging services can help you gain 
                real-time visibility and improve operational efficiency.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
