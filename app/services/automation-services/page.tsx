...
export const metadata: Metadata = {
  title: 'Automation Services | Praelix Technologies',
  ...
  alternates: {
    canonical: 'https://www.praelixtechnologies.com/services/automation-services',
  },
};
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="card-ai p-8">
              ...
              <ul className="space-y-5">
                {[
                  { icon: 'fa-cogs', title: 'Process Automation', desc: 'Automate repetitive business processes' },
                  { icon: 'fa-project-diagram', title: 'Workflow Automation', desc: 'Streamline workflows and improve efficiency' },
                  { icon: 'fa-robot', title: 'AI-Powered Automation', desc: 'Intelligent automation with AI capabilities' },
                  { icon: 'fa-sitemap', title: 'Business Process Automation', desc: 'End-to-end business process automation' }
                ].map((item, idx) => (
