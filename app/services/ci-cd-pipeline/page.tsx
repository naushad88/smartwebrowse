  ...
  const benefits = [
    {
      ...
      description: 'Accelerate software deployment',
    ...
    },
    {
      ...
      description: 'Streamline development workflow',
    ...
    <div>
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl text-primary-700 mb-8 leading-relaxed">
              Professional CI/CD pipeline setup and automation services to streamline 
              your development workflow and accelerate software delivery.
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-body text-gray-600 mb-6">
                Our CI/CD pipeline setup services help organizations automate their 
                development processes, reduce manual errors, and accelerate software delivery.
              </p>
              <p className="text-body text-gray-600 mb-6">
                We design and implement robust CI/CD pipelines that integrate seamlessly 
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Link href="/services/devops-automation-services" className="btn-outline">
            ...
            <div className="bg-white rounded-xl shadow-lg p-8">
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900">Pipeline Design</h4>
                    <p className="text-gray-600">Custom CI/CD pipeline architecture and design</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <i className="fa-solid fa-check-circle text-green-500 mt-1 mr-3 text-xl"></i>
                  <div>
                    ...
                    <p className="text-gray-600">Complete automation of build and deployment processes</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <i className="fa-solid fa-check-circle text-green-500 mt-1 mr-3 text-xl"></i>
                  <div>
                    ...
                    <p className="text-gray-600">Seamless integration with existing tools and systems</p>
                  </div>
                </li>
              </ul>
            </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container-custom">
          <div className="text-center mb-12">
            <h2 className="heading-2 mb-6 text-gray-900">
              Comprehensive CI/CD Pipeline Features
            </h2>
            <p className="text-body text-gray-600 max-w-3xl mx-auto">
              Our CI/CD pipeline solutions cover all aspects of automation, 
              ensuring comprehensive workflow optimization and efficiency.
            </p>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="container-custom">
          <div className="text-center mb-12">
            <h2 className="heading-2 mb-6 text-gray-900">
              Why Choose Our CI/CD Pipeline Services?
            </h2>
            <p className="text-body text-gray-600 max-w-3xl mx-auto">
              We deliver measurable results that enhance your development capabilities and 
        ...
        <div className="container-custom text-center">
          <div className="relative overflow-hidden bg-gradient-to-r from-primary-500 to-primary-600 rounded-3xl p-12 shadow-2xl">
            ...
            <div className="relative z-10">
              <h2 className="text-3xl font-bold text-white mb-4">Ready to Automate Your Pipeline?</h2>
              <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
                Let's discuss how our CI/CD pipeline services can help you streamline 
                your development workflow and accelerate delivery.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
