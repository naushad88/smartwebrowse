  ...
  const benefits = [
    {
      ...
      description: 'Optimized user experience drives conversions',
      icon: 'fa-solid fa-chart-line'
    },
    {
      title: 'Better User Experience',
      description: 'Intuitive design and smooth checkout process',
      icon: 'fa-solid fa-user-check'
    },
    {
      title: 'Scalability',
      description: 'Platform grows with your business needs',
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl text-primary-700 mb-8 leading-relaxed">
              Custom eCommerce solutions to help you build, optimize, and scale your 
              online business with modern technology and best practices.
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-body text-gray-600 mb-6">
                Our eCommerce solutions help businesses create powerful online stores 
                that drive sales and provide exceptional customer experiences.
              </p>
              <p className="text-body text-gray-600 mb-6">
                We develop custom eCommerce platforms with modern technologies, 
                ensuring scalability, security, and performance optimization.
              </p>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8">
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900">Custom Platform</h4>
                    <p className="text-gray-600">Tailored eCommerce solution for your business needs</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <i className="fa-solid fa-check-circle text-green-500 mt-1 mr-3 text-xl"></i>
                  <div>
                    ...
                    <p className="text-gray-600">Secure payment gateway integration and optimization</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <i className="fa-solid fa-check-circle text-green-500 mt-1 mr-3 text-xl"></i>
        ...
        <div className="container-custom">
          <div className="text-center mb-12">
            ...
            <p className="text-body text-gray-600 max-w-3xl mx-auto">
              Our eCommerce solutions cover all aspects of online business, 
      ...
      <section className="py-16 bg-white">
        <div className="container-custom">
          <div className="text-center mb-12">
            ...
            <p className="text-body text-gray-600 max-w-3xl mx-auto">
              We deliver measurable results that enhance your online business and 
        ...
        <div className="container-custom text-center">
          <div className="relative overflow-hidden bg-gradient-to-r from-primary-500 to-primary-600 rounded-3xl p-12 shadow-2xl">
            ...
            <div className="relative z-10">
              <h2 className="text-3xl font-bold text-white mb-4">Ready to Build Your eCommerce Platform?</h2>
              <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
                Let's discuss how our eCommerce solutions can help you create a powerful 
                online store and grow your business.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
